...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        ...
        self.layer2 = self._make_layer(block, 56, num_blocks[1], stride=2)
        self.layer3 = self._make_layer(block, 112, num_blocks[2], stride=2)
        self.layer4 = self._make_layer(block, 224, num_blocks[3], stride=2)
        self.linear = nn.Linear(224*block.expansion, num_classes)
